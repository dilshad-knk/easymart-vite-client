...
import { userAuthSuccess, userLogout } from '../../redux/userAuthenticate';
              ...
              <Row className='my-md-3'>
                ...
                <Col className=' text-center mx-2'>
                  <div className='border  p-5 mx-5'>
                        <p className='d-flex mx-auto'>New to Easy Mart? Sign UP here</p>
                    <NavLink  to="/signup" >
                      <Button variant="primary" onClick={closeModal} className='' >Register</Button>
                    </NavLink>
                  </div>
              </Col>
